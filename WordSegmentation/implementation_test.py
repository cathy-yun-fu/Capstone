...
def split_into_words(filename, output_dir):
	...
	binary_image = np.where(test_image<0.4, 1.0, 0.0)
	...
	fontSize = int(binary_image.shape[1]/11)
	print ("fontSize: ")
	print(fontSize)	
...
# split_into_words('Test_Images/5.png', 'Words_5')
split_into_letters('Words_2/Img3.jpg', 'Words_2/Letters3')
